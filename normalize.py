...
class base_normalizer_factory:

    def __init__(self, language="English"):
        self.language = language
        self.stemmer = base_stemmer_factory(language).get_language()
    ...
    def get_normalizer(self):
        return base_normalizer(self.language)


########################################################################################################################


class base_stemmer_factory:

    stemmers = {'English' : porter_stemmer}
    ...
    def get_stemmer(self):
        return self.stemmers[self.language]()
...
class porter_stemmer(base_stemmer):
